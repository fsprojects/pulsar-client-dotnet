...
type IConsumerInterceptor =
    ...
    abstract member OnNegativeAcksSend: consumer:IConsumer * messageId:MessageId -> unit
    
    abstract member OnAckTimeoutSend: consumer:IConsumer * messageId:MessageId -> unit